...
function clearAllCounts() {
    ...
    var cellX = undefined;
    var cellY = undefined;
    var setCell = undefined;
    var quantityCellsSet = undefined;//Кол-во ячеек необоходимых для проверки(в зависимости от размера корабля). Используется для итераций.
    var shipId = 0;
    var directionAxis  = undefined;
    var countEngagedYes  = undefined; //счетчик на кол-во true занятости проверяемых ячеек
    var accessDirectionArr = []; //Массив доступных направлений для выбора в рандоме
    ////////////////////////////////////////////
    var turnCountPl = 0; //кол-во ходов игрока
    var turnCountAl = 0; //кол-во ходов компа
    ...
    var destrAlCount = 0; // кол-во затопленных кораблей компом
    var alTurnStatus = "default"; //(default - генерит, атакует. search - попал, ищет рядом. ) сюда сохранять string статус предыдущего шага Al чтобы при следующем шаге через IF значения данной переменной определять поведение
    var attackedCell = undefined;
    var attackedSearchCell = undefined;
    var cellXSearch = undefined;
    var cellYSearch = undefined;
    var setCell3 = undefined; //искомая ячейка на 3 шаге
    var cellXNext = undefined;
    var cellYNext = undefined;
    var cellXNext1 = undefined; // переменная для выбоа 1из2 значений рандома на 3 шаге
    var cellYNext1 = undefined; // переменная для выбоа 1из2 значений рандома на 3 шаге
    var cellXNext2 = undefined; // переменная для выбоа 1из2 значений рандома на 3 шаге
    var cellYNext2 = undefined; // переменная для выбоа 1из2 значений рандома на 3 шаге
    var currentAttackedShip = undefined; //раненый корабль
}
